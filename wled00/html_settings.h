...
WiFi Setup</button></form><form style="display:none" action="/settings/leds">
<button type="submit">LED Preferences</button></form><form style="display:none" 
action="/settings/ui"><button type="submit">User Interface</button></form>%DMXMENU%<form 
style="display:none" action="/settings/sync"><button type="submit">
Sync Interfaces</button></form><form style="display:none" 
action="/settings/time"><button type="submit">Time & Macros</button></form><form
 action="/settings/um"><button type="submit">Config</button></form><form 
action="/settings/sec"><button type="submit">Update</button></form></body>
</html>)=====";
...
function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#wifi-settings")}function B(){window.open("/","_self")}function GetV() {var d=document;
...
Configure Access Point</h3>AP SSID (leave empty for no AP):<br><input name="AS" 
maxlength="32"><br>AP password (leave empty for none):<br><input 
type="password" name="AP" maxlength="63" pattern="(.{8,63})|()" 
...
%CSS%%SCSS%</head><body onload="GetV()">
<form id="form_s" name="Sf" method="post"><div style="display:none" 
class="helpB"><button type="button" onclick="H()">?</button></div><button 
type="button" onclick="B()">Back</button><button type="submit">Save & Reboot
</button><hr><h2>Security & Update setup</h2>Factory reset: <input 
type="checkbox" name="RS"><br>All settings and presets will be erased.<br><h3>
Software Update</h3><button type="button" onclick="U()">Manual OTA Update
</button><br>Enable WIFI OTA: <input type="checkbox" name="AO"><br><h3>
...
<br>
Incorrect configuration may require a factory reset or re-flashing of your Andon.
</div><h3>About</h3><a href="https://github.com/Aircoookie/WLED/" 
target="_blank">WLED</a> version 0.13.0-b3<br><br><a 
href="https://github.com/Aircoookie/WLED/wiki/Contributors-and-credits" 
target="_blank">Contributors, dependencies and special thanks</a><br>
A huge thank you to everyone who helped create Andon!<br><br>
