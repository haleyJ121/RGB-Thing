...
</style></head><body><h2>Andon Software Update</h2><form method="POST" 
action="/update" id="uf" enctype="multipart/form-data" onsubmit="U()">
Installed version: 0.13.0-b3<br><input type="file" class="bt" name="update" 
...
Updating...</b><br>Please do not close or refresh the page :)</div></body>
</html>)=====";
